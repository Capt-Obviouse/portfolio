...
/**
 * Constants and utilities for technology-related data.
 * This provides easy access to technology categories and related information
 * that can be used throughout the application, including API responses for the frontend.
 */
object TechnologyConstants {
     ...
     */
    val CATEGORY_INFO: List<Map<String, Any>> = TechnologyCategory.values().map { category ->
        mapOf(
